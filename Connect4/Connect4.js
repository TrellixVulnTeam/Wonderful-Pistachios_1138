...
// Take a coordinate and assemble relevant information
function positionDiagnostics(coordinate) {

	var co_x = coordinate.substring(1);
	var co_y = coordinate.substring(0, 1);

	var diagnosticInfo = [];
	diagnosticInfo[0] = directionsPossible;

	// how many directions are possible
	function directionsPossible() {
